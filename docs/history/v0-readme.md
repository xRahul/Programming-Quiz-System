# v0 README — historical

> Preserved verbatim from `quiz_system_git/readme.md` before it was replaced
> with a pointer to the canonical root `readme.md` during the 2026-08
> revitalization (branch revitalize/v1). Content below is unmodified except
> for this header; the XAMPP-era instructions no longer apply to the
> revitalized tree.
